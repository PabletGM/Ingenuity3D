...
public class AudioManagerSecuencia7 : MonoBehaviour
{
    public static AudioManagerSecuencia7 instance;
    ...
    public void PlayMusic(string name, float volume)
    {
        ...
        SoundSecuencia7 s = Array.Find(musicSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia7 s = Array.Find(dialogueSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia7 s = Array.Find(sfxSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia7 s = Array.Find(transitionSounds, x => x.name == name);
