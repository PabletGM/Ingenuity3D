...
public class AudioManagerSecuencia9 : MonoBehaviour
{
    public static AudioManagerSecuencia9 instance;
    public SoundSecuencia9[] musicSounds, sfxSounds, dialogueSounds, transitionSounds;
    ...
    public void PlayMusic(string name, float volume)
    {
        ...
        SoundSecuencia9 s = Array.Find(musicSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia9 s = Array.Find(dialogueSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia9 s = Array.Find(sfxSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia9 s = Array.Find(transitionSounds, x => x.name == name);
