...
public class AudioManagerSecuencia8 : MonoBehaviour
{
    public static AudioManagerSecuencia8 instance;
    public SoundSecuencia8[] musicSounds, sfxSounds, dialogueSounds, transitionSounds;
    ...
    public void PlayMusic(string name, float volume)
    {
        ...
        SoundSecuencia8 s = Array.Find(musicSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia8 s = Array.Find(dialogueSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia8 s = Array.Find(sfxSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia8 s = Array.Find(transitionSounds, x => x.name == name);
