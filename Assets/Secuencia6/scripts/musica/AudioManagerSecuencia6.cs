...
public class AudioManagerSecuencia6 : MonoBehaviour
{
    ...
    public void PlayMusic(string name, float volume)
    {
        ...
        SoundSecuencia6 s = Array.Find(musicSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia6 s = Array.Find(dialogueSounds, x => x.name == name);
    ...
    {
        //buscamos la musica que queremos poner en el musicSound
        SoundSecuencia6 s = Array.Find(sfxSounds, x => x.name == name);
